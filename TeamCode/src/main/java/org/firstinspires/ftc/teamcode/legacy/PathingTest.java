...
public class PathingTest extends NextFTCOpMode {
    public PathingTest(){
        addComponents(
...
//    private Follower follower;
    ...
    public void buildPaths() {
               ...
               line1 = follower().pathBuilder()
                       ...
                       .setLinearHeadingInterpolation(Math.toRadians(-51.0), Math.toRadians(-51.0))
                       .build();
        ...
        line11 = follower()
                .pathBuilder()
                .addPath(
                        new BezierLine(shootPose1, new Pose(112.000, 72.000))
                )
