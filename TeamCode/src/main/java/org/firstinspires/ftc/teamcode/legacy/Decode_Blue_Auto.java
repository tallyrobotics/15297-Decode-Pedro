...
//    private Follower follower;
    ...
    private final Pose shootPose = new Pose(35.9, 118.3, Math.toRadians(53.2));

    private final Integer shootRPM = 1800;
    ...
    public void buildPaths() {
               ...
               line1 = follower().pathBuilder()
                       .addPath(
                               new BezierLine(new Pose(23.300, 128.600), shootPose)
                       )
