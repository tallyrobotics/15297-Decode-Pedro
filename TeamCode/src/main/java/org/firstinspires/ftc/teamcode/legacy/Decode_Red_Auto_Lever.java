...
//    private Follower follower;
    ...
    public void buildPaths() {
        ...
        line3 = follower()
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(98.000, 83.750+6.5), new Pose(120.000, 83.75+6.5))
                )
        ...
        line4 = follower()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(-95.0), Math.toRadians(-51.0))
                .build();
        ...
        line12 = follower().pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(124.000, 83.750),
                                new Pose(96.827, 76.045),
                                new Pose(129.107, 75.427)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(-95))
